...
public class Register extends javax.swing.JFrame {
  Connection con;
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Login/images-of-people-user-icon-transparent_248589.jpg"))); // NOI18N
        ...
        setSize(new java.awt.Dimension(447, 649));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
               if(jTextField1.getText().equals("")||jTextField2.getText().equals("")||jTextField3.getText().equals("")||jPasswordField1.getText().equals("")||jTextField5.getText().equals("")){
            ...
            rs=pst.executeQuery();
            if(rs.next()){
                JOptionPane.showMessageDialog(null,jTextField3.getText()+"Email exsisst !!!!");                     
            }
            else{    
            String sql2="insert into admin (name,username,email,password,country) values(?,?,?,?,?)";
